...
struct Experement24: View {
    ...
    //ONTAINS[c]работает аналогично, за исключением того, что вместо того, чтобы начинать с вашей подстроки, она может быть в любом месте внутри атрибута.
...
struct Experement24_Previews: PreviewProvider {
